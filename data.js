...
export const daysData = [
    ...
    // DAY 3 - Sunday
    {
        ...
        schedule: [
            ...
            { time: "16:00", title: "🏛️ Panteão", desc: "⚠️ RESERVA MARCADA às 16:00", mapLink: "https://www.pantheonroma.com/", details: ["🎫 Entrada reservada: €5", "⏰ Horário: 16:00", "📍 Apresentar-se 10min antes"], religious: "✝️ Templo pagão convertido em igreja cristã em 609 d.C. (Santa Maria ad Martyres)", highlights: ["Cúpula perfeita - maior cúpula não reforçada do mundo!", "Óculo central (abertura no tecto) - só fonte de luz", "Túmulo de Rafael Sanzio", "Túmulos dos reis de Itália"], tip: "💡 A arquitectura é PERFEITA. Ficam em silêncio a admirar! RESERVA às 16h - chegar 15:50!", icon: "🏛️" },
    ...
    // DAY 4 - Monday
    {
        ...
        intro: "Último dia em Roma! Manhã MUITO cedo dedicada à Roma Antiga: Coliseu, Fórum Romano e Monte Palatino às 08:30 - reserva confirmada! Depois almoço e partida às 14:45 para o aeroporto de carrinha. Voo às 17:55. Arrivederci, Roma! 🏛️✈️",
        summary: { locations: 3, walking: "4km", budget: "€30-50", tickets: 1, holyDoors: 0 },
        schedule: [
            { time: "06:30", title: "Pequeno-almoço CEDO", desc: "Café da manhã bem cedo - dia começa às 08:30!", tip: "💡 Acordar cedo vale a pena - vão ver o Coliseu quase vazio!", icon: "☕" },
            { time: "07:00", title: "Check-out do Hotel", desc: "⏰ Check-out oficial: pode variar - confirmar com hotel", tip: "💡 Deixar malas guardadas na recepção. Vão buscar depois do Coliseu!", icon: "🏨" },
            { time: "07:45", title: "🚇 Ir para o Coliseu", desc: "Metro Linha B ou caminhar", mapLink: "https://www.google.com/maps/dir/Hotel+Quirinale/Colosseum", details: ["METRO: Termini → Colosseo (2 paragens, 3min) - €1.50", "A PÉ: 2km, 25min descida pela Via dei Fori Imperiali", "⏰ Chegar às 08:20 (10min antes da reserva)"], tip: "💡 Saída CEDO mas vale muito a pena - Coliseu quase vazio!", icon: "🚆" },
            { time: "08:30-11:30", title: "🏛️ Coliseu + Fórum Romano + Palatino", desc: "⚠️ RESERVA MARCADA às 08:30", mapLink: "https://parcocolosseo.it/", details: ["🎫 Entrada reservada: 08:30", "⏰ Apresentar-se às 08:20 (10min antes)", "💰 Bilhete combinado já reservado"], religious: "✝️ Palco do martírio de milhares de cristãos. Por isso há uma cruz dentro do Coliseu!", highlights: ["🏛️ Coliseu - anfiteatro flaviano (70-80 d.C.)", "Arena dos gladiadores - capacidade 50.000 espectadores", "Hipogeu - corredores subterrâneos dos gladiadores", "🏛️ Fórum Romano - centro político e social da Roma Antiga", "Templo de Vesta", "Via Sacra - rua principal", "🏛️ Monte Palatino - colina dos imperadores", "Casa de Augusto", "Vistas incríveis sobre o Fórum"], tip: "💡 Começar às 08:30 = MUITO menos turistas! Comecem pelo Coliseu, depois Fórum, depois Palatino. É muita caminhada!", icon: "🏛️" },
            ...
            { time: "14:30-14:45", title: "🚶 Caminhar até Termini", desc: "Do hotel até à estação (5 minutos a pé)", details: ["Hotel Quirinale fica a 400m de Termini", "Seguir pela Via Nazionale"], icon: "🚶" },
            { time: "14:45", title: "🚆 Leonardo Express para Fiumicino", desc: "Comboio direto Termini → Aeroporto", details: ["Duração: 32 minutos", "Frequência: a cada 15-30 min", "Preço: €14 por pessoa", "💡 Comprar bilhetes online ou nas máquinas da estação"], religious: "✝️ Levem a bênção das 4 Portas Santas convosco! 🙏", icon: "🚆" },
            { time: "15:17", title: "Chegada ao Aeroporto Fiumicino", desc: "Leonardo da Vinci International Airport", icon: "✈️" },
